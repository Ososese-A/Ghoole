...
const StockListIndustryPage = () => {
    const {industryId} = useParams()
    const [industryData, setIndustryData] = useState({})
    const [industryStockList, setIndustryStockList] = useState([])
    ...
    useEffect(() => {
        const res = localStorage.getItem(`${industryId}`)
        const result = JSON.parse(res)
        // console.log(JSON.parse(res))
        setIndustryData(result)
        setIndustryStockList(result.stocksArr)
    }, [])

    console.log(industryData)
    console.log(industryData.industry)
    console.log(industryData.symbol)
    console.log(industryData.stocksArr)
    console.log(industryStockList)
    ...
    const labelForPage = `${industryData.industry} (${industryData.symbol})`
...
export default StockListIndustryPage;